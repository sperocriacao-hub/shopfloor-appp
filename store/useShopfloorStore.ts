    ...
    persist(
        (set, get) => ({
            ...
            updateLeanProject: async (id, updates) => {
                ...
                // No explicit error check here in original? Adding one.
                // Note: The original code didn't capture result.
            },

addLeanAction: async (action) => {
    set(s => ({ leanActions: [...s.leanActions, action] }));
    const { error } = await supabase.from('lean_actions').insert({
        id: action.id,
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        syncData: async () => {
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            if (leanProjects) {
                                                                                                                                                                                                                                                                                                                                stateUpdates.leanProjects = leanProjects.map((p: any) => ({
                                                                                                                                                                                                                                                                                                                                    id: p.id, title: p.title, type: p.type, status: p.status, ownerName: p.owner_name, ownerId: p.owner_id,
                                                                                                                                                                                                                                                                                                                                    background: p.background, currentState: p.current_state, targetState: p.target_state,
                                                                                                                                                                                                                                                                                                                                    gapAnalysis: p.gap_analysis, teamMembers: p.team_members || [],
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            if (leanActions) {
                                                                                                                                                                                                                                                                                                                                stateUpdates.leanActions = leanActions.map((a: any) => ({
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    responsibleName: a.responsible_name, dueDate: a.due_date, status: a.status, completedAt: a.completed_at
                                                                                                                                                                                                                                                                                                                                }));
                                                                                                                                                                                                                                                                                                                            }
